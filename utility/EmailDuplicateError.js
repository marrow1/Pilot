  ...
  return(
    ...
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <MaterialCommunityIcons name="email-minus" size={55} color="black" />
       <Text style={styles.errMessage}>This email already registered. Try again!</Text>
      <TouchableRipple rippleColor="rgba(244, 246, 246, .32)" 
      style={styles.registerButton} onPress={()=>{navigation.goBack();}} >
        <Text style={styles.buttonText}>Enter new email</Text>
      </TouchableRipple>
...
export default EmailDuplicateError;